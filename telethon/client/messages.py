...
class MessageMethods:
    ...
    async def send_reaction(
            ...
            message: 'typing.Optional[hints.MessageIDLike]' = None,
            *,
            emoji: 'typing.Union[int, str, typing.Sequence[int], typing.Sequence[str], None]',
            big: bool = False,
        ...
        Arguments
            ...
            emoji (`list` | `int` | `str` | `None`):
                ...
                If it's `None` then all reactions will be removed from the message.
        ...
        return True if await self(request) else False
